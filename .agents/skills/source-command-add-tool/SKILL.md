...
# source-command-add-tool

Use this skill when the user asks to run the migrated source command `add-tool`.
...
{
  name: "$TOOL_NAME",
  description: "One sentence — exactly what this tool does. Be specific so Codex uses it correctly.",
  input_schema: {
...
- [ ] Description is specific enough for Codex to call it at the right time
