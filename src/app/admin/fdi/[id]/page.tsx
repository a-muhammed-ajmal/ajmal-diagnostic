...
type FdiSessionDetail = {
  ...
  readonly q_country: string | null;
  readonly q_industry: string | null;
  readonly q_secondary_sector: string | null;
  ...
  readonly q_founder_led: boolean | null;
  readonly q_founder_decision_authority: string | null;
  readonly q_willing_to_share_operational_information: boolean | null;
