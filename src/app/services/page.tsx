...
const services = [
  ...
  { n: '07', name: 'Lead Response System', stage: 'Entry Point', problem: 'Enquiries arrive on WhatsApp at all hours. Replies are manual, slow, and inconsistent. Leads that message three businesses go to whoever answers first — and it is rarely you.', deliverables: ['Automated capture of every WhatsApp, web form, and Google Business enquiry', 'Instant first response, 24/7, in English and Arabic', 'Qualification questions and lead scoring', 'Automatic logging to CRM with owner assignment', 'Alert routing to the right team member', 'Response-time and conversion reporting'], ideal: 'Founder-led SMEs that want a fast, measurable proof point before committing to a full systems engagement. Typically live within one week.' },
];
